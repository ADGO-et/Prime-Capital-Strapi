...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Editable text and images for the About page';
  ...
  attributes: {
    ...
    visionTitle: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Vision 2030'>;
  };
}
...
export interface ApiContactPageContactPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Editable contact details for the Contact Us page';
  ...
  attributes: {
    ...
    saturdayHours: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Saturday, 8:00 AM - 12:00 PM EAT'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHeroSlideHeroSlide extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Slides shown in the homepage hero image carousel';
  ...
  attributes: {
    ...
    buttons: Schema.Attribute.Component<'shared.hero-button', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Editable text for the homepage sections below the hero slider';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    strategicExcellenceHeading: Schema.Attribute.String &
      Schema.Attribute.Required &
...
export interface ApiJobVacancyJobVacancy extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Open positions shown on the Careers / Vacancy page';
  ...
  attributes: {
    ...
    employmentType: Schema.Attribute.Enumeration<['Full-time', 'Part-time']> &
      Schema.Attribute.Required;
    infoTags: Schema.Attribute.Component<'shared.list-item', true>;
    level: Schema.Attribute.Enumeration<['Junior', 'Intermediate', 'Senior']> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    location: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Addis Ababa, Ethiopia'>;
    publishedAt: Schema.Attribute.DateTime;
    qualifications: Schema.Attribute.Component<'shared.list-item', true>;
    responsibilities: Schema.Attribute.Component<'shared.list-item', true>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiListedCompanyListedCompany
  extends Struct.CollectionTypeSchema {
  collectionName: 'listed_companies';
  info: {
    description: 'Companies listed on the exchange, shown on the Listed Companies page';
    displayName: 'Listed Company';
    pluralName: 'listed-companies';
    singularName: 'listed-company';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    auditor: Schema.Attribute.String;
    boardOfDirectors: Schema.Attribute.Component<'shared.list-item', true>;
    companyAddress: Schema.Attribute.Text;
    companyName: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dateListed: Schema.Attribute.String;
    dateOfIncorporation: Schema.Attribute.String;
    email: Schema.Attribute.Email;
    financialStatements: Schema.Attribute.Component<'shared.link-item', true>;
    listedCapital: Schema.Attribute.String & Schema.Attribute.Required;
    listedCapitalIncludingPremium: Schema.Attribute.String;
    listedShares: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::listed-company.listed-company'
    > &
      Schema.Attribute.Private;
    marketClassification: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Main Market'>;
    natureOfBusiness: Schema.Attribute.String;
    order: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    prospectus: Schema.Attribute.Component<'shared.link-item', false>;
    publishedAt: Schema.Attribute.DateTime;
    sector: Schema.Attribute.String;
    securityType: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Equity \u2013 Ordinary Shares'>;
    shareholders: Schema.Attribute.String & Schema.Attribute.Required;
    subSector: Schema.Attribute.String;
    ...
    yearOfFormation: Schema.Attribute.String;
  };
}
...
export interface ApiNewsArticleNewsArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'News & updates posts shown on the News page';
...
export interface ApiServicesPageServicesPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Editable text for the Services page';
  ...
  attributes: {
    ...
    differentiators: Schema.Attribute.Component<
      'shared.title-description',
      true
    >;
    ...
    processSteps: Schema.Attribute.Component<'shared.title-description', true>;
    processText: Schema.Attribute.Text & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    services: Schema.Attribute.Component<'shared.title-description', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whyChooseHeading: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Why Clients Choose Prime Capital'>;
    whyChooseText: Schema.Attribute.Text & Schema.Attribute.Required;
  };
}
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Board of Directors and Executive Management profiles shown on the Our Team page';
  ...
  attributes: {
    appointed: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    edu: Schema.Attribute.String & Schema.Attribute.Required;
    education: Schema.Attribute.Component<'shared.list-item', true>;
    email: Schema.Attribute.Email;
    exposure: Schema.Attribute.Component<'shared.list-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
